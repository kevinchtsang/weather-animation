...
2. Organise the data into 14 columns (the number of columns in the PDF file).
3. Remove the first 10 rows of extracted data, which are not data of the weather table.
4. Update the column names.
5. Pivot the table into a long format, which is considered as a tidy format for R data wrangling. Meaning the data table will not have the information about 0000 UTC and 1200 UTC in separate columns, but the 0000 UTC will be in one row and 1200 UTC will be in another row.
